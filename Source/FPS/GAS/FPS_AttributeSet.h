...
private:
    ...
    /** Флаг контроля срабатывания Регистрации уничтожения Актора при 'Health == 0'
    @note   Необходим для Регистрации в момент, когда изменение в Атрибуте 'Health' уже учтено */
    bool bIsZeroHealth = false;
    //-------------------------------------------
};
